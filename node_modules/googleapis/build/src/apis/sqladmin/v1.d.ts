...
export declare namespace sqladmin_v1 {
    ...
    export class Resource$Instances {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        restoreBackupMcp(params: Params$Resource$Instances$Restorebackupmcp, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        restoreBackupMcp(params?: Params$Resource$Instances$Restorebackupmcp, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        restoreBackupMcp(params: Params$Resource$Instances$Restorebackupmcp, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        restoreBackupMcp(params: Params$Resource$Instances$Restorebackupmcp, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        restoreBackupMcp(params: Params$Resource$Instances$Restorebackupmcp, callback: BodyResponseCallback<Schema$Operation>): void;
